...
wildfires_settings_effis = {
    "timerange_before": 30,
    "timerange_after_event": 10,
    "bbox_dimension_initial": 150000,
    "resolution": 100,
    "LIMIT_INCLUDED": 0.8,
    "LIMIT_SCORE": 0.3,
    "bbox_dimension": 15000,
}
...
floods_settings = {
    ...
    "resolution": 100,
    "minimum_flooded_area": 3000000,  # Minimum area of the flooding in square meters
...
air_pollution_settings = {
    ...
    "fis_evalscript": air_pollution_fis_evalscript,
    "evalscript": air_pollution_image_evalscript,
