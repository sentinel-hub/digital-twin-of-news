...
import { EOB_THEMES_FOR_TYPE, SH_TO_EOB_ID, EFFIS_VIIRS_FIRES } from '../../const';
...
function EventInfo(props) {
  ...
  async function getPreview(layer) {
    ...
    const isEffisLayer = layer.dataset.id === EFFIS_VIIRS_FIRES.id;
    ...
    return layer.getMap(getMapParams, isEffisLayer ? ApiType.WMS : ApiType.PROCESSING, requestsConfig);
  }
