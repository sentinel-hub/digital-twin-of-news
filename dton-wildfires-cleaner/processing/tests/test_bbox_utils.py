...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            153.16695,
            150000,
            BBox((152.42158800537553, -25.92442493746853, 153.9123119946245, -24.576135062531467), crs=CRS.WGS84),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (np.array([[0, 1], [0, 0]]), (0, 0, 10, 10), (5, 5, 10, 10), (slice(0, 1, None), slice(1, 2, None))),
        (
